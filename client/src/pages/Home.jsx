...
function Home() {
    ...
    const fetchFriends = async () => {
        try {
            const res = await axios.get(`${API}/api/friends/list`, authHeaders);
            setFriends(res.data);
        } catch (error) {
    ...
    const fetchDiscoverUsers = async () => {
        try {
            const res = await axios.get(`${API}/api/friends/discover`, authHeaders);
    ...
    const fetchPendingRequests = async () => {
        try {
            const res = await axios.get(`${API}/api/friends/pending`, authHeaders);
    ...
    const fetchGroups = async () => {
        try {
            const res = await axios.get(`${API}/api/groups/my-groups`, authHeaders);
            setGroups(res.data);
        } catch (error) {
    ...
    const sendFriendRequest = async (receiverId) => {
        try {
            const res = await axios.post(`${API}/api/friends/request`, { receiverId }, authHeaders);
    ...
    const acceptRequest = async (requestId) => {
        try {
            await axios.put(`${API}/api/friends/accept/${requestId}`, {}, authHeaders);
    ...
    const rejectRequest = async (requestId) => {
        try {
            await axios.put(`${API}/api/friends/reject/${requestId}`, {}, authHeaders);
            setPendingRequests(prev => prev.filter(r => r._id !== requestId));
    ...
    const selectChat = async (friend) => {
        ...
        try {
            const res = await axios.get(`${API}/api/messages/${friend._id}`, authHeaders);
    ...
    const selectGroup = async (group) => {
        ...
        setIsMobileChatOpen(true);
        try {
            const res = await axios.get(`${API}/api/groups/${group._id}/messages`, authHeaders);
    ...
    const createGroup = async () => {
        ...
        try {
            const res = await axios.post(`${API}/api/groups/create`, {
